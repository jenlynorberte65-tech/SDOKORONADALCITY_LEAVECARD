...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @media print { body { font-size: 10px !important; } thead { display: table-header-group; } .card { page-break-inside: avoid; } }
  </style>
</head>
<body>
...
export default function UserPage({ onLogout }: Props) {
  ...
  return (
    <div>
      {/* ── Action bar — Logout removed, only PDF & Print remain ── */}
